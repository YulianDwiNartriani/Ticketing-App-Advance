<x-layouts.admin title="Edit Diskon">
    <div class="container mx-auto p-10">
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <h2 class="card-title text-2xl mb-6">Edit Diskon</h2>

                <form action="{{ route('admin.diskons.update', $diskon) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-control w-full mb-4">
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="datetime-local"
                                name="mulai_at"
                                value="{{ old('field', $diskon->mulai_at) }}"
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="datetime-local"
                                name="berakhir_at"
                                value="{{ old('field', $diskon->berakhir_at) }}"
